...
const EMPTY_FORM = {
  name: '',
  description: 'A luxury rental property with modern amenities.',
  location: '',
  address: '',
  capacity: 4, bedrooms: 1, bathrooms: 1,
  daily_price: 100, weekly_price: 600, monthly_price: 2000,
  security_deposit: 200, cleaning_fee: 50,
...
export default function Properties() {
  ...
  const handleSubmit = () => {
    ...
    const finalForm = {
      ...form,
      description: form.description.trim() || 'A luxury rental property with modern amenities.',
      address: form.address.trim() || form.location.trim() || '123 Main Street',
    };
    if (editingId) {
      updateProperty(editingId, finalForm);
    } else {
      addProperty({ ...finalForm, gallery: [finalForm.cover_photo], rules: {}, is_approved: false });
    }
